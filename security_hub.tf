...
# Note: Security Hub standards ARNs vary by region and may not be available in all regions
# You can enable these manually in the AWS Console after deployment
